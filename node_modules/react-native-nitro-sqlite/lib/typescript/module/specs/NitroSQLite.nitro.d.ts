...
import type { BatchQueryResult, FileLoadResult, BatchQueryCommand, SQLiteQueryParams } from '../types';
...
export interface NitroSQLite extends HybridObject<{
    ...
    execute(dbName: string, query: string, params?: SQLiteQueryParams): NativeQueryResult;
    executeAsync(dbName: string, query: string, params?: SQLiteQueryParams): Promise<NativeQueryResult>;
